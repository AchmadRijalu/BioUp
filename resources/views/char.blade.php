...
@section('content')
    ...
    <div class="bg-greenySecond flex flex-row justify-center   min-h-screen">
        ...
        <div class="h-full grid sm-grid-cols-1 gap-8 md:grid-cols-1 xl:grid-cols-2  mt-5">
            ...
            <div
                class="bg-white mt-3 cursor-pointer md:w-cardviewwidth2 md:h-cardviewheight2 // sm:w-minicardwidth sm:h-minicardheight // hover:bg-second transition delay-50 rounded-xl shadow-2xl flex flex-row"
                    ...
                    <div class=" w-1/2 h-full flex flex-col">
                        ...
                        <div class=" justify-end w-full h-1/2 flex flex-col  font-poppins px-5 py-3">
                            <div class="w-full flex flex-row items-center">
                                <img src="{{asset('image/nyawa.svg')}}" alt="" class="w-8 h-8"> <span class="ml-2">X 3</span>
                            </div>
                        </div>

                    </div>
                    <div class=" justify-end items-center w-1/2 h-full flex flex-row">
                        <img src="{{asset('image/Touki.svg')}}" alt="" class=" drop-shadow-2xl w-52 h-52">
                    </div>
            </div>
            <div
